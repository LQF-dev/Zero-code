...
import com.ai.ratelimiter.anotation.RateLimit;
import com.ai.ratelimiter.enms.RateLimitType;
import com.ai.service.AppService;
import com.ai.service.ProjectDownloadService;
...
//    @Cacheable(
//            value = "good_app_page",
//            key = "T(com.ai.utils.CacheKeyUtils).generateKey(#appQueryRequest)",
